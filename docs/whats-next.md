...
The [k6 listing on the Dynatrace Hub](https://www.dynatrace.com/hub/detail/grafana-k6/){target=_blank} contains information about how to build your own custom k6 binary using `xk6`.
